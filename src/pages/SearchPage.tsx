...
import { Search, MapPin, Calendar, Building2, Map, List, Navigation, X, ChevronRight } from 'lucide-react';
                ...
                <SplitLayout
                  ...
                  left={
                    <div className="space-y-4 pr-1 overflow-y-auto h-full">
                      {/* Hint strip */}
                      {!selectedPropertyId && results.length > 0 && (
                        <div className="hidden lg:flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-50 border border-blue-100 text-blue-600 text-xs font-medium">
                          ...
                          <span>Click any property to view its full details alongside</span>
                        </div>
                      )}
