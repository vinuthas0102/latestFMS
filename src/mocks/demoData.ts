...
export const DEMO_TENANT_REQUESTS: QuarterTenantRequest[] = [
  ...
  // Vacate request for C-205 (allot-005) — Stage 1: New vacate request, no inspection scheduled yet
  {
    id: 'tr-008',
  ...
  // Vacate request for B-310 (allot-002) — Stage 2: Inspection scheduled, awaiting employee acceptance
  {
    id: 'tr-009',
    allotment_id: 'allot-002',
    employee_id: '5f865f74-aeab-4885-a898-80ba3da33ae0',
    service_type: 'VACATE',
    request_status: 'PENDING',
    remarks: 'Transferred to Mumbai HQ. Vacating quarter B-310 by 15 July 2025. Inspection requested before handover.',
    reason: 'Transfer to Mumbai HQ effective 15 July 2025.',
    document_url: '',
    requested_date: '2025-07-15',
    required_bhk_config: '',
    eo_notes: 'Inspection scheduled for 28 June 2025, 02:00 PM – 04:00 PM. Inspector: Rajiv Sharma. Awaiting employee acceptance.',
    grievance_subject: '',
    urgency_level: 'NORMAL',
    retention_reason: '',
    requested_months: null,
  ...
  // Vacate request for E-108 (allot-003) — Stage 3: Inspection scheduled, employee accepted, inspector report submitted
  {
    id: 'tr-010',
    allotment_id: 'allot-003',
    employee_id: '5f865f74-aeab-4885-a898-80ba3da33ae0',
    service_type: 'VACATE',
    request_status: 'PENDING',
    remarks: 'Deputation period completed. Vacating quarter E-108 by 30 July 2025. Physical inspection completed by assigned inspector.',
    reason: 'Deputation ended — returning to parent cadre.',
    document_url: '',
    requested_date: '2025-07-30',
    required_bhk_config: '',
    eo_notes: 'Inspection completed on 25 June 2025. Inspector report submitted with damage findings. Awaiting EO completion.',
    grievance_subject: '',
    urgency_level: 'NORMAL',
    retention_reason: '',
    requested_months: null,
  ...
  // Vacate request for F-216 (allot-006) — Stage 4: Inspection completed by EO, ready for Accept/Reject
  {
    id: 'tr-011',
    allotment_id: 'allot-006',
    employee_id: '5f865f74-aeab-4885-a898-80ba3da33ae0',
    service_type: 'VACATE',
    request_status: 'PENDING',
    remarks: 'Retiring on 31 August 2025. Inspection completed. All findings reviewed. Ready for final decision.',
    reason: 'Superannuation — retirement effective 31 August 2025.',
    document_url: '',
    requested_date: '2025-08-31',
    required_bhk_config: '',
    eo_notes: 'Inspection completed by EO on 20 August 2025. No major damages. Final report uploaded. Ready for Accept/Reject.',
    grievance_subject: '',
    urgency_level: 'NORMAL',
    retention_reason: '',
    requested_months: null,
  ...
  // Vacate request — Stage 5: Accepted (completed vacate)
  {
    id: 'tr-012',
    allotment_id: 'allot-005',
    employee_id: '5f865f74-aeab-4885-a898-80ba3da33ae0',
    service_type: 'VACATE',
    request_status: 'APPROVED',
    remarks: 'Vacate request approved. Quarter C-205 handed over successfully. Inspection report confirmed no major damages.',
    reason: 'Transfer to Chennai HQ.',
    document_url: '',
    requested_date: '2025-04-30',
    required_bhk_config: '',
    eo_notes: 'Vacate approved. Inspection report confirmed good condition. Key handover completed on 30 April 2025.',
    grievance_subject: '',
    urgency_level: 'NORMAL',
    retention_reason: '',
    requested_months: null,
  ...
  // Vacate request — Stage 6: Rejected (insufficient notice)
  {
    id: 'tr-013',
    allotment_id: 'allot-002',
    employee_id: '5f865f74-aeab-4885-a898-80ba3da33ae0',
    ...
    remarks: 'Vacate request rejected due to insufficient notice period. Employee requested to resubmit with 30 days notice.',
    reason: 'Premature vacate request without proper notice.',
    document_url: '',
    requested_date: '2025-03-15',
    required_bhk_config: '',
    eo_notes: 'Rejected — employee did not provide mandatory 30-day notice. Asked to resubmit with proper notice period.',
    grievance_subject: '',
    urgency_level: 'NORMAL',
    retention_reason: '',
    requested_months: null,
...
// ─── Vacate inspection detailed records (for demo flow) ───────────────────────

import type { VacateInspectionDetail } from '../components/quarters/manager/InspectionReportViewModal';

export const DEMO_VACATE_INSPECTIONS: VacateInspectionDetail[] = [
  // tr-009: Inspection scheduled, awaiting employee acceptance
  {
    id: 'vin-001',
    tenantRequestId: 'tr-009',
    inspectorName: 'Rajiv Sharma',
    inspectionDate: '2025-06-28',
    timeSlot: '02:00 PM – 04:00 PM',
    status: 'SCHEDULED',
    employeeAccepted: 'PENDING',
    propertyCondition: '',
    openingRemarks: 'Vacate inspection for B-310. Inspector assigned by EO. Employee acceptance pending.',
    closingRemarks: '',
    findings: [],
    uploadedDocs: [],
    damagePhotos: [],
    auditTrail: [
      { timestamp: '2025-06-15T09:00:00Z', actor: 'Employee (Suresh Nair)', action: 'Vacate request submitted' },
      { timestamp: '2025-06-20T14:00:00Z', actor: 'Estate Manager', action: 'Inspection scheduled for 28 June 2025, 02:00 PM – 04:00 PM. Inspector: Rajiv Sharma.' },
      { timestamp: '2025-06-20T14:05:00Z', actor: 'System', action: 'Auto-dispatch email sent to Employee, Estate Office, Inspector.' },
    ],
  },
  // tr-010: Inspection scheduled, employee accepted, inspector report submitted with damage findings
  {
    id: 'vin-002',
    tenantRequestId: 'tr-010',
    inspectorName: 'Priya Menon',
    inspectionDate: '2025-06-25',
    timeSlot: '09:00 AM – 11:00 AM',
    status: 'IN_PROGRESS',
    employeeAccepted: 'ACCEPTED',
    propertyCondition: 'FAIR',
    openingRemarks: 'Vacate inspection for E-108. Employee accepted schedule. Inspector conducted physical inspection on 25 June 2025.',
    closingRemarks: 'Inspection conducted. Damages found in bathroom and kitchen. Deduction recommended for wall paint and broken fixtures.',
    findings: [
      { id: 'f-001', item: 'Wall paint damage — living room', category: 'Civil', estimatedCost: 4500, deductionAmount: 3500, remarks: 'Peeling paint and water stains on living room walls.' },
      { id: 'f-002', item: 'Broken bathroom faucet', category: 'Plumbing', estimatedCost: 1200, deductionAmount: 800, remarks: 'Main bathroom faucet broken. Needs replacement.' },
      { id: 'f-003', item: 'Kitchen cabinet hinge damage', category: 'Carpentry', estimatedCost: 800, deductionAmount: 500, remarks: 'Two cabinet hinges broken in kitchen.' },
      { id: 'f-004', item: 'Electrical fixture — missing tube light', category: 'Electrical', estimatedCost: 600, deductionAmount: 400, remarks: 'One tube light fixture missing from bedroom.' },
    ],
    uploadedDocs: [
      { name: 'inspection-report-E108-25Jun2025.pdf', type: 'PDF', size: '1.2 MB' },
      { name: 'signed-inspection-form-E108.pdf', type: 'PDF', size: '850 KB' },
    ],
    damagePhotos: [
      { name: 'wall-damage-living-room.jpg', type: 'JPEG' },
      { name: 'faucet-bathroom.jpg', type: 'JPEG' },
      { name: 'kitchen-cabinet-hinge.jpg', type: 'JPEG' },
    ],
    auditTrail: [
      { timestamp: '2025-06-10T08:00:00Z', actor: 'Employee', action: 'Vacate request submitted' },
      { timestamp: '2025-06-15T10:00:00Z', actor: 'Estate Manager', action: 'Inspection scheduled for 25 June 2025, 09:00 AM – 11:00 AM. Inspector: Priya Menon.' },
      { timestamp: '2025-06-16T09:00:00Z', actor: 'Employee', action: 'Inspection schedule accepted.' },
      { timestamp: '2025-06-25T11:30:00Z', actor: 'Inspector (Priya Menon)', action: 'Inspection conducted. Damage findings updated with 4 items.' },
      { timestamp: '2025-06-25T11:35:00Z', actor: 'Inspector (Priya Menon)', action: 'Inspection report generated and uploaded.' },
      { timestamp: '2025-06-25T12:00:00Z', actor: 'Inspector (Priya Menon)', action: '3 damage photographs uploaded as supporting evidence.' },
      { timestamp: '2025-06-25T12:05:00Z', actor: 'Inspector (Priya Menon)', action: 'Final inspection report submitted to Estate Manager.' },
    ],
  },
  // tr-011: Inspection completed by EO, ready for final decision
  {
    id: 'vin-003',
    tenantRequestId: 'tr-011',
    inspectorName: 'Self (Estate Manager)',
    inspectionDate: '2025-08-20',
    timeSlot: '03:00 PM – 05:00 PM',
    status: 'COMPLETED',
    employeeAccepted: 'ACCEPTED',
    propertyCondition: 'GOOD',
    openingRemarks: 'Vacate inspection for F-216. EO conducted self-inspection. Employee accepted schedule.',
    closingRemarks: 'Inspection completed. Quarter found in good condition. Minor wear and tear only. No major damages. Ready for vacate approval.',
    findings: [
      { id: 'f-005', item: 'Minor wall scuff marks', category: 'Civil', estimatedCost: 500, deductionAmount: 0, remarks: 'Minor scuff marks in corridor. Normal wear and tear.' },
    ],
    uploadedDocs: [
      { name: 'final-inspection-report-F216.pdf', type: 'PDF', size: '920 KB' },
      { name: 'eo-completion-remarks.pdf', type: 'PDF', size: '410 KB' },
    ],
    damagePhotos: [
      { name: 'corridor-scuff-marks.jpg', type: 'JPEG' },
    ],
    auditTrail: [
      { timestamp: '2025-07-15T10:00:00Z', actor: 'Employee', action: 'Vacate request submitted' },
      { timestamp: '2025-08-10T11:00:00Z', actor: 'Estate Manager', action: 'Inspection scheduled for 20 August 2025, 03:00 PM – 05:00 PM. Inspector: Self.' },
      { timestamp: '2025-08-12T09:00:00Z', actor: 'Employee', action: 'Inspection schedule accepted.' },
      { timestamp: '2025-08-20T17:00:00Z', actor: 'Estate Manager', action: 'Inspection conducted. 1 minor finding recorded.' },
      { timestamp: '2025-08-20T17:15:00Z', actor: 'Estate Manager', action: 'Final inspection report uploaded.' },
...
export const DEMO_RENT_TILES: RentTile[] = [
  ...
  rt('rt-0601','allot-001','2026-06',T.t001, 50,null,  0,       null,         'OVERDUE', '2026-06-05',null,           null,           null, 0,0,0, 6700,      '2024-03-15','2024-03-20', null),
  ...
  // ── May 2026 ──────────────────────────────────────────────────────────────
  rt('rt-0501','allot-001','2026-05',T.t001,200,null,   0,       null,         'OVERDUE', '2026-05-05','2026-04-04',  null,           null, 0,0,0, 6700,      '2024-03-15','2024-03-20', null),
  ...
  rt('rt-0503','allot-003','2026-05',T.t003,850,null,  0,       null,         'OVERDUE', '2026-05-05','2026-03-03',  null,           null, 0,0,0, 9200,      '2022-06-01','2022-06-15', null),
  ...
  rt('rt-0505','allot-005','2026-05',T.t005,100,null,3800,     'CASH',         'OVERDUE', '2026-05-05','2026-05-02',  null,           null, 0,0,0, 3800,      '2023-04-01','2023-04-05', null),
  ...
  rt('rt-0507','allot-007','2026-05',T.t007,150,null,   0,       null,         'OVERDUE', '2026-05-05','2026-03-04',  null,           null, 0,0,0, 5150,      '2025-01-15','2025-01-20', null),
  rt('rt-0508','allot-008','2026-05',T.t008,600,null,  0,       null,         'OVERDUE', '2026-05-05','2026-03-04',  null,           null, 0,0,0, 6500,      '2023-07-01','2023-07-10', null),
  ...
  rt('rt-0511','allot-011','2026-05',T.t011,300,null,   0,       null,         'OVERDUE', '2026-05-05','2026-04-03',  null,           null, 0,0,0, 8000,      '2024-10-01','2024-10-08', null),
  ...
  rt('rt-0403','allot-003','2026-04',T.t003,425,null,  0,       null,         'OVERDUE', '2026-04-05','2026-03-03',  null,           null, 0,0,0, 9200),
  rt('rt-0404','allot-004','2026-04',T.t004, 0,null,   0,     'EXEMPTED',     'EXEMPTED','2026-04-05',null,           null,           'Medical grounds'),
  rt('rt-0405','allot-005','2026-04',T.t005, 0,null,0,       null,          'OVERDUE', '2026-04-05',null,           null,           null),
  rt('rt-0406','allot-006','2026-04',T.t006, 0,null,7000,     'ONLINE',       'PAID',    '2026-04-04','2026-04-04',  'RCP-2604-0058',null),
  rt('rt-0407','allot-007','2026-04',T.t007,250,null,   0,       null,         'OVERDUE', '2026-04-05','2026-03-04',  null,           null, 0,0,0, 5150),
  rt('rt-0408','allot-008','2026-04',T.t008,300,null,  0,       null,         'OVERDUE', '2026-04-05','2026-03-04',  null,           null, 0,0,0, 6500),
  ...
  rt('rt-0411','allot-011','2026-04',T.t011,150,null,4000,     'CASH',         'OVERDUE', '2026-04-05','2026-04-03',  null,           null),
  rt('rt-0412','allot-012','2026-04',T.t012,1000,null, 0,       null,         'OVERDUE', '2026-04-05','2026-03-02',  null,           null, 0,0,0, 10000),
  // ── March 2026 ────────────────────────────────────────────────────────────
  ...
  rt('rt-0305','allot-005','2026-03',T.t005, 0,null,0,       null,          'OVERDUE', '2026-03-05',null,           null,           null),
  ...
  rt('rt-0311','allot-011','2026-03',T.t011,180,null,   0,       null,         'OVERDUE', '2026-03-05','2026-02-03',  null,           null, 0,0,0, 8000),
  rt('rt-0312','allot-012','2026-03',T.t012, 0,null,0,       null,          'OVERDUE', '2026-03-02',null,           null,           null),
  // ── February 2026 ─────────────────────────────────────────────────────────
  ...
  rt('rt-0205','allot-005','2026-02',T.t005,200,null,3900,     'CASH',         'OVERDUE', '2026-02-05','2026-02-02',  null,           null),
  rt('rt-0206','allot-006','2026-02',T.t006, 0,null,7000,     'ONLINE',       'PAID',    '2026-02-04','2026-02-04',  'RCP-2602-0041',null),
  rt('rt-0207','allot-007','2026-02',T.t007,100,null,   0,       null,         'OVERDUE', '2026-02-05','2026-01-03',  null,           null, 0,0,0, 5150),
  rt('rt-0208','allot-008','2026-02',T.t008,150,null,  0,       null,         'OVERDUE', '2026-02-05','2026-01-04',  null,           null, 0,0,0, 6500),
  ...
  rt('rt-0103','allot-003','2026-01',T.t003,925,null,  0,       null,         'OVERDUE', '2026-01-05','2025-12-03',  null,           null, 0,0,0, 9200),
  rt('rt-0104','allot-004','2026-01',T.t004, 0,null,   0,     'EXEMPTED',     'EXEMPTED','2026-01-05',null,           null,           'Medical grounds'),
  rt('rt-0105','allot-005','2026-01',T.t005, 0,null,0,       null,          'OVERDUE', '2026-01-05',null,           null,           null),
  rt('rt-0106','allot-006','2026-01',T.t006, 0,null,7000,     'ONLINE',       'PAID',    '2026-01-04','2026-01-04',  'RCP-2601-0053',null),
  rt('rt-0107','allot-007','2026-01',T.t007, 75,null,   0,       null,         'OVERDUE', '2026-01-05','2025-12-04',  null,           null, 0,0,0, 5150),
  ...
  rt('rt-0112','allot-012','2026-01',T.t012,250,null,5000,     'CASH',         'OVERDUE', '2026-01-05','2026-01-04',  null,           null),
  // ── December 2025 ─────────────────────────────────────────────────────────
  ...
  rt('rt-1205','allot-005','2025-12',T.t005,300,null,4000,     'CASH',         'OVERDUE', '2025-12-05','2025-12-02',  null,           null),
  ...
  rt('rt-1208','allot-008','2025-12',T.t008,130,null,  0,       null,         'OVERDUE', '2025-12-05','2025-11-04',  null,           null, 0,0,0, 6500),
  ...
  rt('rt-1211','allot-011','2025-12',T.t011, 90,null,   0,       null,         'OVERDUE', '2025-12-05','2025-11-03',  null,           null, 0,0,0, 4000),
  ...
  rt('rt-1103','allot-003','2025-11',T.t003,185,null,  0,       null,         'OVERDUE', '2025-11-05','2025-10-03',  null,           null, 0,0,0, 9200),
  ...
  rt('rt-1106','allot-006','2025-11',T.t006, 60,null,   0,       null,         'OVERDUE', '2025-11-05','2025-10-04',  null,           null, 0,0,0, 7000),
  ...
  rt('rt-1111','allot-011','2025-11',T.t011,350,null,4000,     'CASH',         'OVERDUE', '2025-11-05','2025-11-03',  null,           null),
  ...
  rt('rt-s501','allot-013','2026-05',T.t013,120,null,   0,       null,         'OVERDUE', '2026-05-05',null,           null,           null, 10000, 0, 800),
  ...
  rt('rt-h501','allot-014','2026-05',T.t014, 0,null,   0,       null,         'OVERDUE', '2026-05-10',null,           null,           null, 0, 25000, 0),
