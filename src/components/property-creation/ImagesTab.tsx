...
export const ImagesTab: React.FC<ImagesTabProps> = ({ formData, updateFormData }) => {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mb-6">
          Upload images of the property. The first image will be used as the cover photo. Maximum {MAX_IMAGE_COUNT} images, 10MB each.
        </p>
      </div>
      ...
      >
        ...
        <Button onClick={onButtonClick} variant="outline" disabled={images.length >= MAX_IMAGE_COUNT}>
          Select Files
        </Button>
      </div>
